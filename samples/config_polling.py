# ruff: noqa: E402
"""Read-only periodic Host Link collection driven by a JSON or YAML configuration file."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Run read-only Host Link polling from a JSON or YAML config file.")
